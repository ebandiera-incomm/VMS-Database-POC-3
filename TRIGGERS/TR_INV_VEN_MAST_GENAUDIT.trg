CREATE OR REPLACE TRIGGER VMSCMS.TR_INV_VEN_MAST_GENAUDIT
AFTER  INSERT OR UPDATE OR DELETE ON VMSCMS.CMS_INVENTORYVENDOR_MAST FOR EACH ROW
DECLARE
  ------------------------------------------------------------------------------------------------
...
BEGIN
  ...
  V_TABLE_NM := 'CMS_INVENTORYVENDOR_MAST';
  ...
  P_DTL_INFO(1).COL_NAME := 'CIM_VENDOR_CODE';
  P_DTL_INFO(2).COL_NAME := 'CIM_VENDOR_NAME';
  ...
  P_DTL_INFO(1).OLD_VAL := :OLD.CIM_VENDOR_CODE;
  P_DTL_INFO(2).OLD_VAL := :OLD.CIM_VENDOR_NAME;
  ...
  P_DTL_INFO(1).NEW_VAL := :NEW.CIM_VENDOR_CODE;
  P_DTL_INFO(2).NEW_VAL := :NEW.CIM_VENDOR_NAME;
