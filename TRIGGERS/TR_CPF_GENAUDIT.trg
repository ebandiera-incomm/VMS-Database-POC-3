CREATE OR REPLACE TRIGGER VMSCMS.TR_CPF_GENAUDIT
AFTER  INSERT OR UPDATE OR DELETE ON  CMS_PROD_FEES FOR EACH ROW
DECLARE
 ------------------------------------------------------------------------------------------------
...
P_DTL_INFO(2).COL_NAME := 'CPF_FEE_CODE';
P_DTL_INFO(3).COL_NAME := 'CPF_VALID_FROM';
P_DTL_INFO(4).COL_NAME := 'CPF_VALID_TO';
P_DTL_INFO(5).COL_NAME := 'CPF_INS_USER';
P_DTL_INFO(6).COL_NAME := 'CPF_INS_DATE';
P_DTL_INFO(7).COL_NAME := 'CPF_LUPD_USER';
P_DTL_INFO(8).COL_NAME := 'CPF_LUPD_DATE';
P_DTL_INFO(1).OLD_VAL := :OLD.CPF_PROD_CODE;
P_DTL_INFO(2).OLD_VAL := :OLD.CPF_FEE_CODE;
P_DTL_INFO(3).OLD_VAL := :OLD.CPF_VALID_FROM;
P_DTL_INFO(4).OLD_VAL := :OLD.CPF_VALID_TO;
P_DTL_INFO(5).OLD_VAL := :OLD.CPF_INS_USER;
P_DTL_INFO(6).OLD_VAL := :OLD.CPF_INS_DATE;
P_DTL_INFO(7).OLD_VAL := :OLD.CPF_LUPD_USER;
P_DTL_INFO(8).OLD_VAL := :OLD.CPF_LUPD_DATE;
P_DTL_INFO(1).NEW_VAL := :NEW.CPF_PROD_CODE;
P_DTL_INFO(2).NEW_VAL := :NEW.CPF_FEE_CODE;
P_DTL_INFO(3).NEW_VAL := :NEW.CPF_VALID_FROM;
P_DTL_INFO(4).NEW_VAL := :NEW.CPF_VALID_TO;
P_DTL_INFO(5).NEW_VAL := :NEW.CPF_INS_USER;
P_DTL_INFO(6).NEW_VAL := :NEW.CPF_INS_DATE;
P_DTL_INFO(7).NEW_VAL := :NEW.CPF_LUPD_USER;
P_DTL_INFO(8).NEW_VAL := :NEW.CPF_LUPD_DATE;
