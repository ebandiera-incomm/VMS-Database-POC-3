CREATE OR REPLACE TRIGGER VMSCMS.TR_CBR_GENAUDIT
AFTER  INSERT OR UPDATE OR DELETE ON VMSCMS.CMS_BRANCH_REGION FOR EACH ROW
DECLARE
 ------------------------------------------------------------------------------------------------
...
P_DTL_INFO(1).COL_NAME := 'CBR_REGION_ID';
P_DTL_INFO(2).COL_NAME := 'CBR_BRAN_CODE';
...
P_DTL_INFO(1).OLD_VAL := :OLD.CBR_REGION_ID;
P_DTL_INFO(2).OLD_VAL := :OLD.CBR_BRAN_CODE;
...
P_DTL_INFO(1).NEW_VAL := :NEW.CBR_REGION_ID;
P_DTL_INFO(2).NEW_VAL := :NEW.CBR_BRAN_CODE;
