...
/*************************************************
     ...
     * Modified by      :  RAVI N 
     * Modified Reason  :  MVCSD-4471 [Fee description logging ]
           ...
           --cam_acct_bal replaced by Pankaj S. with cam_ledger_bal for 10871
            ...
            EXCEPTION
               ...
               THEN
                  ...
                  --Strart- comment on 04/02/14 for MVCSD-4471
                   /*
             ...
             --End Comment on 04/02/14 for MVCSD-4471
            ...
            BEGIN
                           SELECT CFM_FEE_DESC 
                               INTO v_narration
                               FROM CMS_FEE_MAST
                               WHERE CFM_INST_CODE=:NEW.cam_inst_code AND
