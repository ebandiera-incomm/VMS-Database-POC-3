CREATE OR REPLACE TRIGGER VMSCMS.TR_CUG_GENAUDIT
AFTER  INSERT OR UPDATE OR DELETE ON VMSCMS.CMS_USER_GROUP FOR EACH ROW
DECLARE
 ------------------------------------------------------------------------------------------------
...
P_DTL_INFO(1).COL_NAME := 'CUG_GROUP_CODE'; -- NOT USED
P_DTL_INFO(2).COL_NAME := 'CUG_GROUP_NAME';
P_DTL_INFO(3).COL_NAME := 'CUG_INS_USER';
P_DTL_INFO(4).COL_NAME := 'CUG_INS_DATE';
P_DTL_INFO(5).COL_NAME := 'CUG_LUPD_USER';
P_DTL_INFO(6).COL_NAME := 'CUG_LUPD_DATE';


P_DTL_INFO(1).OLD_VAL := :OLD.CUG_GROUP_CODE;
P_DTL_INFO(2).OLD_VAL := :OLD.CUG_GROUP_NAME;
P_DTL_INFO(3).OLD_VAL := :OLD.CUG_INS_USER;
P_DTL_INFO(4).OLD_VAL := :OLD.CUG_INS_DATE;
P_DTL_INFO(5).OLD_VAL := :OLD.CUG_LUPD_USER;
P_DTL_INFO(6).OLD_VAL := :OLD.CUG_LUPD_DATE;


P_DTL_INFO(1).NEW_VAL := :NEW.CUG_GROUP_CODE;
P_DTL_INFO(2).NEW_VAL := :NEW.CUG_GROUP_NAME;
P_DTL_INFO(3).NEW_VAL := :NEW.CUG_INS_USER;
P_DTL_INFO(4).NEW_VAL := :NEW.CUG_INS_DATE;
P_DTL_INFO(5).NEW_VAL := :NEW.CUG_LUPD_USER;
P_DTL_INFO(6).NEW_VAL := :NEW.CUG_LUPD_DATE;
