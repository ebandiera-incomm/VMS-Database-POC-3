CREATE OR REPLACE TRIGGER VMSCMS.TR_PRODCCC_GENAUDIT
AFTER  INSERT OR UPDATE OR DELETE ON VMSCMS.CMS_PROD_CCC FOR EACH ROW
DECLARE
 ------------------------------------------------------------------------------------------------
...
P_DTL_INFO(1).COL_NAME := 'CPC_CUST_CATG';
P_DTL_INFO(2).COL_NAME := 'CPC_CARD_TYPE';
P_DTL_INFO(3).COL_NAME := 'CPC_PROD_CODE';
...
P_DTL_INFO(1).OLD_VAL := :OLD.CPC_CUST_CATG ;
P_DTL_INFO(2).OLD_VAL := :OLD.CPC_CARD_TYPE;
P_DTL_INFO(3).OLD_VAL := :OLD.CPC_PROD_CODE;
...
P_DTL_INFO(1).NEW_VAL := :NEW.CPC_CUST_CATG ;
P_DTL_INFO(2).NEW_VAL := :NEW.CPC_CARD_TYPE;
P_DTL_INFO(3).NEW_VAL := :NEW.CPC_PROD_CODE;
