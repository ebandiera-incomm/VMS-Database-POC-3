CREATE TABLE VMSCMS.CMS_MERCCATG_LOYL
(
  CML_INST_CODE   NUMBER(3)                     NOT NULL,
  CML_LOYL_CODE   NUMBER(3)                     NOT NULL,
  CML_MERC_CATG   VARCHAR2(4 BYTE)              NOT NULL,
...
ALTER TABLE VMSCMS.CMS_MERCCATG_LOYL ADD (
  CONSTRAINT PK_MERCCATG_LOYL
 PRIMARY KEY
 (CML_INST_CODE, CML_LOYL_CODE))
/

ALTER TABLE VMSCMS.CMS_MERCCATG_LOYL ADD (
  CONSTRAINT FK_MERCCATGLOYL_LOYLMAST 
 FOREIGN KEY (CML_INST_CODE, CML_LOYL_CODE) 
 REFERENCES VMSCMS.CMS_LOYL_MAST (CLM_INST_CODE,CLM_LOYL_CODE),
  CONSTRAINT FK_MERCCATGLOYL_MERCCATG 
 FOREIGN KEY (CML_INST_CODE, CML_MERC_CATG) 
 REFERENCES VMSCMS.MCCODE (ACT_INST_CODE,MCCODE),
  CONSTRAINT FK_MERCCATGLOYL_USERMAST1 
 FOREIGN KEY (CML_INS_USER) 
 REFERENCES VMSCMS.CMS_USER_MAST (CUM_USER_PIN),
  CONSTRAINT FK_MERCCATGLOYL_USERMAST2 
