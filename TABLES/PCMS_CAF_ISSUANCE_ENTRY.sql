CREATE TABLE VMSCMS.PCMS_CAF_ISSUANCE_ENTRY
(
  ...
  CCI_EXP_DAT               VARCHAR2(5 BYTE),
  CCI_REC_TYP               CHAR(1 BYTE),
  CCI_CRD_TYP               VARCHAR2(5 BYTE),
  CCI_REQUESTER_NAME        VARCHAR2(30 BYTE),
  CCI_PROD_CODE             VARCHAR2(12 BYTE)   NOT NULL,
  CCI_CARD_TYPE             NUMBER(2)           DEFAULT 1                     NOT NULL,
  CCI_SEG12_BRANCH_NUM      VARCHAR2(4 BYTE),
  CCI_FIID                  VARCHAR2(4 BYTE)    NOT NULL,
  CCI_TITLE                 VARCHAR2(5 BYTE)    NOT NULL,
  ...
  CCI_PROD_AMT              VARCHAR2(10 BYTE)   NOT NULL,
  ...
  CCI_LUPD_DATE             DATE,
  CCI_SERIAL_NO             NUMBER(14)          NOT NULL
)
