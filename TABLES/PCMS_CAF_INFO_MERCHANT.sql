CREATE TABLE VMSCMS.PCMS_CAF_INFO_MERCHANT
(
  ...
  CCI_MERC_CUST_ID          VARCHAR2(15 BYTE),
  CCI_KYC_REASON            VARCHAR2(30 BYTE),
  CCI_KYC_FLAG              VARCHAR2(1 BYTE)    NOT NULL,
