...
CREATE OR REPLACE FORCE VIEW vmscms.dmrv_process_entities (process_id,
                                                           process_ovid,
                                                           entity_id,
                                                           entity_ovid,
                                                           flow_id,
...
AS
   SELECT process_id, process_ovid, entity_id, entity_ovid, flow_id,
          ...
          flow_direction, model_id, model_ovid, model_name, design_ovid
     FROM dmrs_process_entities;
