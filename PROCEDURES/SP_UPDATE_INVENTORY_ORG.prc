CREATE OR REPLACE PROCEDURE VMSCMS.Sp_Update_Inventory_org (instcode IN NUMBER,lupduser IN NUMBER, errmsg OUT VARCHAR2)
AS
CURSOR c1 IS
...
EXCEPTION
WHEN OTHERS THEN
errmsg:='Exception whil e updating inventory quantity';
END;
/
