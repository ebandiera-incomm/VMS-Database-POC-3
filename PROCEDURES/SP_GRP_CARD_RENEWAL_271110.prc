CREATE OR REPLACE PROCEDURE VMSCMS.sp_grp_card_renewal_271110
  (
    ...
    LOOP
      ...
      LOOP
        ...
        BEGIN               --<<CARD WISE LOOP>>
          ...
          sp_caf_rfrsh (prm_inst_code, k.cap_pan_code, '000', SYSDATE, 'C', NULL, 'RENEW', prm_lupd_user, v_errmsg );
          IF v_errmsg != 'OK' THEN
