CREATE OR REPLACE PROCEDURE VMSCMS.Sp_Entry_Newcaf_Merchant (
...
/*************************************************
     ...
     * PURPOSE          : Application Processing for merchat Customer.
     * Modified By     :.
     * Modified Date  :.
   ...
   ***********************************************/
   ...
   v_comm_addr_lin1        PCMS_CAF_INFO_MERCHANT.cci_seg12_addr_line1%TYPE;
   v_comm_addr_lin2        PCMS_CAF_INFO_MERCHANT.cci_seg12_addr_line2%TYPE;
   v_comm_postal_code      PCMS_CAF_INFO_MERCHANT.cci_seg12_postal_code%TYPE;
   v_comm_homephone_no     PCMS_CAF_INFO_MERCHANT.cci_seg12_homephone_no%TYPE;
   v_comm_mobileno         PCMS_CAF_INFO_MERCHANT.cci_seg12_mobileno%TYPE;
   v_comm_emailid          PCMS_CAF_INFO_MERCHANT.cci_seg12_emailid%TYPE;
   v_comm_city             PCMS_CAF_INFO_MERCHANT.cci_seg12_city%TYPE;
   v_comm_state            PCMS_CAF_INFO_MERCHANT.cci_seg12_state%TYPE;
   v_other_addr_lin1       PCMS_CAF_INFO_MERCHANT.cci_seg13_addr_line1%TYPE;
   v_other_addr_lin2       PCMS_CAF_INFO_MERCHANT.cci_seg13_addr_line2%TYPE;
   v_other_postal_code     PCMS_CAF_INFO_MERCHANT.cci_seg13_postal_code%TYPE;
   v_other_homephone_no    PCMS_CAF_INFO_MERCHANT.cci_seg13_homephone_no%TYPE;
   v_other_mobileno        PCMS_CAF_INFO_MERCHANT.cci_seg13_mobileno%TYPE;
   v_other_emailid         PCMS_CAF_INFO_MERCHANT.cci_seg13_emailid%TYPE;
   v_other_city            PCMS_CAF_INFO_MERCHANT.cci_seg13_city%TYPE;
   v_other_state           PCMS_CAF_INFO_MERCHANT.cci_seg12_state%TYPE;
   ...
   IS
      SELECT cci_inst_code, cci_file_name, cci_row_id, cci_appl_code,
             ...
             cci_drawn_date, cci_payref_no, cci_merc_cust_id, cci_kyc_reason,
             ...
             cci_lupd_date, cci_comments, cci_merc_id, ROWID r
        FROM PCMS_CAF_INFO_MERCHANT
         ...
         THEN
            BEGIN
               INSERT INTO pcms_merchant_cards
                    ...
                    VALUES (prm_instcode, i.cci_merc_id, v_acct_id,
