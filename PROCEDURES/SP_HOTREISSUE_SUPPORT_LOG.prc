CREATE OR REPLACE PROCEDURE VMSCMS.sp_hotreissue_support_log
(
...
--En create record u
 EXCEPTION
 WHEN OTHERS THEN
 prm_errmsg := 'Error while creating record in cms hotreissue detail table ' || substr(sqlerrm,1,150);
 RETURN;
 END;
