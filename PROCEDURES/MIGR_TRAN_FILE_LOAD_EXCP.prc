CREATE OR REPLACE PROCEDURE VMSCMS.MIGR_TRAN_FILE_LOAD_EXCP
AS
   ...
   IS
    SELECT DISTINCT MFI_FILE_NAME FileName,
           MFI_PROCESS_STATUS ProcessMessage
...
BEGIN
   v_errmsg := 'OK';
   v_sqlerrmsg := 'OK';
   l_file_name := 'TRAN_FILE_LOAD_EXCP.csv';
