CREATE OR REPLACE PROCEDURE VMSCMS.sp_revrse_loyl	(	instcode	IN	NUMBER	,
...
END IF;
	...
	/*Added on 2-11-2002 by anup to populate the cms_loyl_audit table*/
		INSERT INTO CMS_LOYL_AUDIT(	CLA_INST_CODE    ,
					...
					VALUES(	instcode	,
						...
						calc_loyl_points,
						SYSDATE		,
						'Loyalty points debit for chargeback',
						lupduser	,
						lupduser	);
