CREATE OR REPLACE PROCEDURE VMSCMS.sp_upld_limits(instcode IN VARCHAR2,
                     rsncode IN NUMBER,
				 ...
				 END IF;
						...
						IF ERRMSG = 'OK' THEN
						   BEGIN
							...
							X.CUC_NEWPOS_LIMIT,
							X.CUC_NEWPOS_LIMIT,
							'U', -- to indicate the update has happended through the upload procedure -- jimmy 16th Feb'05
                     lupduser,
							errmsg);
							IF errmsg != 'OK' THEN
                     		...
                     		SET CUC_DONE_FLAG = 'Y',
                           CUC_PROCESS_USED = 'U', -- jimmy 16th Feb'05
                           CUC_PROCESS_RESULT = 'Limits Updated Successfully'
