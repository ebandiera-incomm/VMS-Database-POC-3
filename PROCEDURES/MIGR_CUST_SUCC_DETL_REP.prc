CREATE OR REPLACE PROCEDURE VMSCMS.MIGR_CUST_SUCC_DETL_REP 
AS
...
BEGIN
   v_errmsg := 'OK';
   v_sqlerrmsg := 'OK';
   l_file_name := 'CUST_SUCC_DETL_REP.csv';
   ...
   THEN
      ...
      UTL_FILE.put (l_file, 'CARD STATUS,');
      ...
      LOOP
         ...
         THEN
            BEGIN
               ...
               UTL_FILE.put (l_file, cur_data.CardStatus || ',');
