create or replace
PROCEDURE        vmscms.sp_gen_pan_debit_inv (
   prm_instcode          IN       NUMBER,
   prm_applcode          IN       NUMBER,
   prm_lupduser          IN       NUMBER,
   prm_pan               OUT      VARCHAR2,
   prm_encr_pan          OUT      VARCHAR2,
   ...
   BEGIN
      INSERT INTO cms_appl_pan
                  (cap_appl_code, cap_inst_code, cap_asso_code,
                   ...
                   cap_join_feecalc, cap_next_bill_date, cap_next_mb_date,
                   cap_request_id, cap_issue_flag, cap_ins_user,
                   cap_lupd_user, cap_atm_offline_limit,
                   cap_atm_online_limit, cap_pos_offline_limit,
                   cap_pos_online_limit, cap_ecom_online_limit,
                   cap_ecom_offline_limit, cap_offline_aggr_limit,
                   cap_online_aggr_limit, cap_emp_id, cap_firsttime_topup,
                   cap_ikit_flag, cap_panmast_param1, cap_panmast_param2,
           ...
           VALUES (prm_applcode, prm_instcode, v_asso_code,
                   ...
                   'N', NULL, NULL,
                   v_request_id, v_issueflag, prm_lupduser,
                   prm_lupduser, v_offline_atm_limit,
                   v_online_atm_limit, v_offline_pos_limit,
                   v_online_pos_limit, v_online_ecom_limit,
                   v_offline_ecom_limit, v_offline_aggr_limit,
                   v_online_aggr_limit, v_emp_id, NULL,
                   v_ikit_flag, v_appl_data (1), v_appl_data (2),
