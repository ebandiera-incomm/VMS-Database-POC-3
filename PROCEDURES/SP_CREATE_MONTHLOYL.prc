CREATE OR REPLACE PROCEDURE VMSCMS.sp_create_monthloyl	(instcode		IN	NUMBER	,
													loylcatg		IN	NUMBER	,
													firstdate		IN	DATE		,--of the month
...
BEGIN			--Main begin
	...
	IF errmsg = 'OK' THEN
	--begin 2 block inserts rows into cms_loyl_mast and cms_month_loyl
	BEGIN		--Begin 2
	...
	INSERT INTO CMS_MONTH_LOYL	(CML_INST_CODE		,
								CML_LOYL_CODE		,
								CML_FIRST_DATE	 	,
								CML_LAST_DATE		,
								CML_TRANS_AMT		,
