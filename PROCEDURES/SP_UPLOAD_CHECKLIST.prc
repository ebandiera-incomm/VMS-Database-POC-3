CREATE OR REPLACE PROCEDURE VMSCMS.Sp_Upload_Checklist(instcode IN NUMBER,
...
CURSOR c1 IS
	...
	AND	cci_fiid NOT IN (SELECT cbm_bran_code
				FROM CMS_BRAN_MAST);
...
BEGIN
	...
	EXCEPTION
		WHEN NO_DATA_FOUND THEN
			Sp_Create_Branch(instcode,1,1,1,x.cbm_bran_code,x.cbm_bran_code,NULL,'CHN','CHN',NULL,NULL,'400001','28277045',NULL,NULL,'ARIF KHAN' , NULL , 'infod@hdfcbank.com',0,0 ,lupduser,err);
