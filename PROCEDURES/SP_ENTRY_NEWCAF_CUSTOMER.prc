CREATE OR REPLACE PROCEDURE VMSCMS.sp_entry_newcaf_customer (
...
/*************************************************
     ...
     * PURPOSE          : Application Processing for Customer.
     * Modified By     :.
     * Modified Date  :.
   ...
   ***********************************************/
   ...
   v_comm_addr_lin1        pcms_caf_info_customer.cci_seg12_addr_line1%TYPE;
   v_comm_addr_lin2        pcms_caf_info_customer.cci_seg12_addr_line2%TYPE;
   v_comm_postal_code      pcms_caf_info_customer.cci_seg12_postal_code%TYPE;
   v_comm_homephone_no     pcms_caf_info_customer.cci_seg12_homephone_no%TYPE;
   v_comm_mobileno         pcms_caf_info_customer.cci_seg12_mobileno%TYPE;
   v_comm_emailid          pcms_caf_info_customer.cci_seg12_emailid%TYPE;
   v_comm_city             pcms_caf_info_customer.cci_seg12_city%TYPE;
   v_comm_state            pcms_caf_info_customer.cci_seg12_state%TYPE;
   v_other_addr_lin1       pcms_caf_info_customer.cci_seg13_addr_line1%TYPE;
   v_other_addr_lin2       pcms_caf_info_customer.cci_seg13_addr_line2%TYPE;
   v_other_postal_code     pcms_caf_info_customer.cci_seg13_postal_code%TYPE;
   v_other_homephone_no    pcms_caf_info_customer.cci_seg13_homephone_no%TYPE;
   v_other_mobileno        pcms_caf_info_customer.cci_seg13_mobileno%TYPE;
   v_other_emailid         pcms_caf_info_customer.cci_seg13_emailid%TYPE;
   v_other_city            pcms_caf_info_customer.cci_seg13_city%TYPE;
   v_other_state           pcms_caf_info_customer.cci_seg12_state%TYPE;
   ...
   IS
      SELECT cci_inst_code, cci_file_name, cci_row_id, cci_appl_code,
             ...
             cci_drawn_date, cci_payref_no, --cci_emp_id, Not needed in customer as discussed with kirti 
			 cci_kyc_reason,
   ...
   LOOP
	  ...
	  -- Sn Check instrument_realised first is Y or not
         ...
         BEGIN
            ...
            v_errmsg := 'Customer number is already present in master ';
            RAISE exp_reject_record;
			END IF;*/
				BEGIN 
         ...
         THEN
            BEGIN
               INSERT INTO pcms_corporate_cards
                    ...
                    VALUES (prm_instcode, i.cci_corp_id, v_acct_numb,
