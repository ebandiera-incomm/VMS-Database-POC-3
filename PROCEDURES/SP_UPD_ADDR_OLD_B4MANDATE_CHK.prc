CREATE OR REPLACE PROCEDURE VMSCMS.SP_UPD_ADDR_OLD_B4MANDATE_CHK      (
				   instcode  IN NUMBER,
				   lupduser IN NUMBER,
...
v_mbrnumb		VARCHAR2(3)	; ---shyam 05 04 05
  ...
  CAU_PIN_CODE,CAU_CNTRY_CODE,CAU_PHONE_ONE,CAU_PHONE_TWO ,ROWID
  FROM CMS_ADDR_UPDATE WHERE CAU_DONE_FLAG = 'N';
