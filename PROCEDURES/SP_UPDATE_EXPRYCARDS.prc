CREATE OR REPLACE PROCEDURE VMSCMS.SP_UPDATE_EXPRYCARDS(prm_instcode IN number,
...
BEGIN
   ...
   FOR i in C1
              ...
              --En get caf detail          
               ...
               BEGIN                                --Begin -4
                     Sp_Caf_Rfrsh (prm_instcode,
                                  Fn_Dmaps_Main(i.cap_pan_code_encr),
                                  --Fn_Dmaps_Main(i.cap_pan_code_encr),
                                   i.cap_mbr_numb,
                                   SYSDATE,
                                   'C',
      ...
      THEN
         ...
         BEGIN
            INSERT INTO cms_audit_log_process
                 ...
                 VALUES (prm_instcode, '', '',
                         i.cap_pan_code, '', 'GROUP EXPIRY CARD CLOSE',
                         'INSERT', 'SUCCESS', prm_ipaddr,
                         'CMS_PAN_SPPRT', '', i.cap_pan_code_encr,
    ...
    BEGIN
      ...
      -- Uncommented by Ramkumar to Update the flag in the Inst Master table for the expired cards closure...
