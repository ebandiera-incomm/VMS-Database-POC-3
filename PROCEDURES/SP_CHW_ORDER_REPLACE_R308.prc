create or replace PROCEDURE               VMSCMS.sp_chw_order_replace_r308 (
...
IS
    ...
    * Modified Date    : 30-Jul-2020
    * Purpose          : Update activity 30.8
...
BEGIN
   ...
   EXCEPTION
      WHEN NO_DATA_FOUND
      THEN
         v_err_msg := 'Pan not found in master old ' || v_hash_pan;
         v_resp_cde := '21';
         RAISE exp_reject_record;
      WHEN OTHERS
      THEN
  ...
  END IF;
   ELSE
      ...
      BEGIN
         SP_ORDER_REISSUEPAN_CMS_R308 (p_inst_code,
                                       p_card_no,
                                       v_prod_code,
                                       v_prod_cattype,
                                       new_dispname,
         ...
         BEGIN
              BEGIN
               ...
               EXCEPTION
                  WHEN NO_DATA_FOUND
                  THEN
                     v_err_msg := 'Pan not found in master new '  || v_new_hash_pan;
                     v_resp_cde := '21';
                     RAISE exp_reject_record;
                  WHEN OTHERS
                  THEN
      ...
      BEGIN
         INSERT INTO transactionlog (msgtype,
              ...
              VALUES (
                        ...
                        '',
                        v_auth_id,
                        'Card replacement update activity 30.8',
                        TRIM (
