CREATE OR REPLACE PROCEDURE VMSCMS.sp_create_mercloyl( instcode IN NUMBER ,
      loylcatg IN NUMBER ,
...
errmsg := 'OK';
 ...
 IF v_clc_catg_sname != 'MERC' THEN
 errmsg := 'Allowed only for Merchant code based loyalty';
 END IF;
 ...
 INSERT INTO CMS_MERC_LOYL ( CML_INST_CODE  ,
         CML_LOYL_CODE  ,
         CML_MERC_CODE ,
         CML_TRANS_AMT  ,
         CML_LOYL_POINT  ,
