CREATE OR REPLACE PROCEDURE VMSCMS.sp_reissue_pan_271110 (
...
BEGIN                                                       --<< MAIN BEGIN >>
   ...
   BEGIN
      SELECT cap_prod_catg, cap_prod_code, cap_card_type
        ...
        FROM cms_appl_pan
       WHERE cap_pan_code = prm_old_pancode AND cap_inst_code = prm_instcode;
   EXCEPTION
      WHEN NO_DATA_FOUND
      THEN
                    ...
                    BEGIN
                        BEGIN
                            ...
                            cgh_process_msg='Successful',
                             cgh_new_card_no=prm_newpan
                            where cgh_inst_code=prm_instcode
                            and cgh_process_flag='N'
                            and cgh_card_no=prm_old_pancode                           
