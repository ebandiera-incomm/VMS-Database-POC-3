create or replace
PROCEDURE               VMSCMS.SP_ORDER_REISSUEPAN_CMS_R305 (
...
AS
   /*************************************************************************************
     ...
     * Modified Reason  : For update activity 30.5
     * Reviewer         : Pankaj salunkhe
...
--      WHEN NO_DATA_FOUND
--      THEN
--         INSERT INTO cms_pan_ctrl (cpc_inst_code,
--                                   cpc_pan_prefix,
--                                   cpc_ctrl_numb,
--                                   cpc_max_serial_no)
--              VALUES (l_instcode,
...
--         THEN
--            BEGIN
--               INSERT INTO cms_shfl_cntrl (csc_inst_code,
--                                           csc_prod_code,
--                                           csc_card_type,
--                                           csc_shfl_cntrl,
--                                           csc_ins_user)
...
--         ROLLBACK;
--
--         INSERT INTO cms_serl_error (cse_inst_code,
--                                     cse_prod_code,
--                                     cse_prod_catg,
--                                     cse_ordr_rfrno,
--                                     cse_err_mseg)
...
--      v_loop_cnt := 0;
--
--      FOR i IN c (v_cardtype_profile_code)
--      LOOP
 ...
 --EN:Added for 17.07 PAN Inventory Changes
   ...
   BEGIN
      ...
      THEN
         ...
         /*INSERT INTO cms_appl_pan_replace_r305
            SELECT cap_pan_code,
                   cap_inst_code,
                   cap_mbr_numb,
                   cap_prod_catg,
                   ...
                   SYSDATE
              FROM cms_appl_pan a
             WHERE cap_inst_code = cap_inst_code
                   AND cap_pan_code = v_hash_new_pan;*/
      END IF;
