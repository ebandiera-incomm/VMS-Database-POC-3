CREATE OR REPLACE PROCEDURE VMSCMS.sp_dup_acct_inact_spill (
      ...
      BEGIN
         ...
         LOOP
            BEGIN
               ...
               BEGIN
                  SELECT COUNT (*)                       --need to check count
                    INTO v_spil_check
                    FROM transactionlog
                   WHERE customer_card_no = z.cap_pan_code
               ...
               EXCEPTION
                  ...
                  THEN
                     v_errmsg :=
                           'Error while verifying SPIL txn - '
